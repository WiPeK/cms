<div class="news_archive_template">
	<div class="articles_list">
		...
		<?php if (count($search_data_art)): foreach ($search_data_art as $sr_data): ?>
			<div class="row">
 				<article>
 					<div class="col-lg-3">
...
<div class="news_archive_template">
	<div class="articles_list">
		...
		<?php if (count($search_data_pg)): foreach ($search_data_pg as $sr_data): ?>
			<div class="row">
 				<article>
 					<div class="col-lg-3">
 						<a class="a_articles_list" href="<?php echo site_url() . $sr_data->slug; ?>">
 							<img src="<?php echo site_url() . $sr_data->logo; ?>" alt="<?php echo $sr_data->title; ?>">
 						</a>
 					</div>
 					<div class="col-lg-9 narticle_right">
 						<?php echo get_excerpt_page($sr_data); ?>
 					</div>
 				</article>
 			</div><hr>
		<?php endforeach; else: ?>
