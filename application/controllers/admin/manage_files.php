...
/**
* Files Controller in admin dashboard
*
* @package		WiPeK CMS
...
class Manage_files extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->data['subview'] = 'admin/manage_files';
	...
	public function do_upload()
	{
		...
		if($this->input->post('upload'))
		{
			...
			else
			{
				...
				$this->logi_m->create_log_upload_file($this->data['file_title'],$this->data['extension']);
	...
	public function delete_file($file_title)
	{
		...
		$this->logi_m->create_log_delete_file($title);
